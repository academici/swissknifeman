...
- Каталог `.cursor/skills/` в репозитории может содержать копии из экосистемы агента; **правило редактирования доменных скиллов SOVA** — всё равно через `.ai/skills/` и повторная генерация.
