...
bucket: php
version: 0.1.0
description: "Лучшие практики Laravel: 20 категорий правил (Eloquent, валидация, кеш, очереди, безопасность) с маршрутизацией по задаче"
risk: write
persona: oss-dev
...
**Laravel Boost**: в проектах с установленным Boost используй его встроенный скилл laravel-best-practices — он версионно-специфичен и обновляется с пакетом; этот скилл — для проектов без Boost.
